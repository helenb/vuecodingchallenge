...
if getattr(settings, "PATTERN_LIBRARY_ENABLED", False) and apps.is_installed(
    ...
    from vuecodingchallenge.project_styleguide.views import example_form
...
# Error handlers
handler404 = "vuecodingchallenge.utils.views.page_not_found"
handler500 = "vuecodingchallenge.utils.views.server_error"
