...
PRODUCTION_APP_INSTANCE = "vuecodingchallenge-production"
STAGING_APP_INSTANCE = "vuecodingchallenge-staging"
DEVELOPMENT_APP_INSTANCE = "vuecodingchallenge-dev"

LOCAL_MEDIA_FOLDER = "media"
LOCAL_IMAGES_FOLDER = "media/original_images"
LOCAL_DATABASE_NAME = PROJECT_NAME = "vuecodingchallenge"
LOCAL_DATABASE_USERNAME = "vuecodingchallenge"
...
def docker_coverage(c):
    return dexec(
        "coverage erase && coverage run manage.py test \
            --settings=vuecodingchallenge.settings.test && coverage report",
        service="web",
    )
...
def run_test(c):
    ...
    subprocess.call(
        [
            ...
            "manage.py",
            "test",
            "--settings=vuecodingchallenge.settings.test",
            "--parallel",
        ]
    )
