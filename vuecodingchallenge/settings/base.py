"""
Django settings for vuecodingchallenge project.
"""
import os
import sys
...
INSTALLED_APPS = [
    ...
    "scout_apm.django",
    "vuecodingchallenge.documents",
    "vuecodingchallenge.events",
    "vuecodingchallenge.forms",
    "vuecodingchallenge.home",
    "vuecodingchallenge.images",
    "vuecodingchallenge.navigation",
    "vuecodingchallenge.news",
    "vuecodingchallenge.people",
    "vuecodingchallenge.search",
    "vuecodingchallenge.standardpages",
    "vuecodingchallenge.users",
    "vuecodingchallenge.utils",
...
ROOT_URLCONF = "vuecodingchallenge.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "vuecodingchallenge.utils.context_processors.global_vars",
            ],
...
WSGI_APPLICATION = "vuecodingchallenge.wsgi.application"
...
DATABASES = {
    "default": dj_database_url.config(
        conn_max_age=600, default="postgres:///vuecodingchallenge"
    )
}
...
if "SENTRY_DSN" in env:
    ...
    # dokku config:set vuecodingchallenge SENTRY_ENVIRONMENT=staging
...
WAGTAIL_SITE_NAME = "Vue coding challenge"
